package com.michael.authservice.config.mongodb;

import com.michael.authservice.domain.MongoAccessToken;
import com.michael.authservice.domain.MongoRefreshToken;
